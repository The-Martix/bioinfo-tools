...
Aminotools es una librería de funciones en Python diseñada para facilitar el
acceso a propiedades fisicoquímicas de aminoácidos, conversiones entre formatos
y herramientas básicas para análisis de codones y posibles mutaciones.
